...
export default function WelcomePage() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-[#06070b] text-gray-900 dark:text-white flex items-center justify-center p-4 relative overflow-hidden">
      {/* Background Glow */}
      <div className="absolute top-1/4 left-1/4 w-[500px] h-[500px] bg-indigo-600/[0.03] dark:bg-indigo-600/5 rounded-full blur-[140px] pointer-events-none" />
      <div className="absolute bottom-1/4 right-1/4 w-[500px] h-[500px] bg-blue-600/[0.03] dark:bg-blue-600/5 rounded-full blur-[140px] pointer-events-none" />
      ...
      <div className="max-w-xl w-full relative z-10">
        ...
        <div className="bg-white/80 dark:bg-slate-900/40 backdrop-blur-md border border-black/5 dark:border-white/5 p-8 md:p-12 rounded-3xl shadow-2xl overflow-hidden relative min-h-[460px] flex flex-col justify-between">
          <AnimatePresence mode="wait">
            ...
            {step === 3 && (
              ...
              >
                <div className="flex flex-col items-center">
                  <div className="w-16 h-16 bg-emerald-500/10 border border-emerald-500/20 text-emerald-600 dark:text-emerald-400 rounded-full flex items-center justify-center mb-6 shadow-xl">
