  ...
  return (
    <header className="mb-8 text-gray-900 dark:text-white">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <h1 className="text-2xl sm:text-3xl font-black tracking-tight text-gray-900 dark:text-white bg-clip-text [text-wrap:balance]">
            Welcome back, {displayName}
          </h1>
          <p className="text-sm text-gray-500 dark:text-gray-400 mt-1 flex items-center">
            <span className="inline-block w-2 h-2 rounded-full bg-indigo-500 mr-2" aria-hidden="true"></span>
        ...
        <div className="flex items-center px-5 py-2.5 bg-white dark:bg-[var(--surface-1)] rounded-xl border border-black/10 dark:border-white/5 shadow-lg transition-all duration-305">
          <div className="mr-3 h-8 w-8 flex items-center justify-center rounded-lg bg-gradient-to-br from-amber-500 to-red-500 bg-opacity-20" aria-hidden="true">
          ...
          <div>
            <div className="font-semibold text-sm text-gray-900 dark:text-white tabular-nums">{streakDays}-day streak!</div>
        ...
        <div className="relative">
          <button 
            ...
            className="rounded-full focus-visible:ring-2 focus-visible:ring-indigo-500 focus:outline-none"
          >
            <motion.div 
