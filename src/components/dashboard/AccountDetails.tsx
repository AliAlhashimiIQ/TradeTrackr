  ...
  return (
    <div className="bg-white dark:bg-gradient-to-br dark:from-[#181e2e]/80 dark:to-[#232a3d]/80 rounded-2xl shadow-xl border border-black/5 dark:border-blue-900/20 p-6 mb-8 transition-colors duration-300">
      <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-4 flex items-center gap-2">
        <svg className="w-7 h-7 text-indigo-600 dark:text-blue-400" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 8c-2.21 0-4 1.79-4 4s1.79 4 4 4 4-1.79 4-4-1.79-4-4-4zm0 10c-4.41 0-8-3.59-8-8s3.59-8 8-8 8 3.59 8 8-3.59 8-8 8z" /></svg>
        Account Details
      </h3>
          ...
          {editing ? (
            <div className="flex items-center gap-2 mt-1">
              <input
                ...
                className="p-2 rounded bg-gray-100 dark:bg-[var(--surface-3)] text-indigo-600 dark:text-blue-400 font-bold border border-black/10 dark:border-blue-700/30 focus:ring-2 focus:ring-indigo-500 w-32 focus:outline-none"
              />
              <button
      ...
      <div className="mt-6">
        ...
        <div className="flex justify-between text-[11px] text-gray-400 dark:text-gray-500 mt-2 font-bold uppercase">
          <span>Start</span>
          <span>Now</span>
        </div>
      </div>
