...
export default function DashboardSummary() {
  ...
  return (
    <div className="max-w-7xl mx-auto px-2 sm:px-6 lg:px-8 py-8 bg-slate-50 dark:bg-gradient-to-br dark:from-[#10131c] dark:via-[#181e2e] dark:to-[#232a3d] min-h-screen rounded-3xl shadow-2xl border border-black/5 dark:border-blue-900/30 backdrop-blur-xl relative overflow-hidden transition-colors duration-300">
      ...
      <div className="relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-8">
          <div className="lg:col-span-2 space-y-8">
            {/* Recent trades */}
            <div className="bg-white dark:bg-gradient-to-br dark:from-[#181e2e]/80 dark:to-[#232a3d]/80 rounded-2xl shadow-xl border border-black/5 dark:border-blue-900/20 hover:shadow-2xl transition-all">
