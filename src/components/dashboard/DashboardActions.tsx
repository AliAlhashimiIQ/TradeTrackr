...
export default function DashboardActions() {
  return (
    <div className="flex flex-wrap gap-2 mb-6">
      <Link 
        href="/trades/new"
        className="inline-flex items-center px-4 py-2 bg-white dark:bg-[var(--surface-2)] hover:bg-gray-100 dark:hover:bg-[var(--surface-3)] border border-black/10 dark:border-transparent text-gray-850 dark:text-white text-sm font-semibold rounded-xl transition-all shadow-sm"
      >
