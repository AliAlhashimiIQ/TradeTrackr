...
export function SkeletonCard({ className = '' }: { className?: string }) {
  return (
    <div className={`rounded-2xl border border-black/5 dark:border-white/[0.06] bg-white dark:bg-[var(--surface-1)] p-5 space-y-3 ${className}`}>
...
export function SkeletonChart({ className = '' }: { className?: string }) {
  return (
    <div className={`rounded-2xl border border-black/5 dark:border-white/[0.06] bg-white dark:bg-[var(--surface-1)] p-5 ${className}`}>
...
export function DashboardSkeleton() {
  return (
    ...
    >
      ...
      {/* Recent trades */}
      <div className="rounded-2xl border border-black/5 dark:border-white/[0.06] bg-white dark:bg-[var(--surface-1)] overflow-hidden">
...
export function AnalyticsSkeleton() {
  return (
    ...
    >
      ...
      {/* Brief panel */}
      <div className="rounded-2xl border border-black/5 dark:border-white/[0.06] bg-white dark:bg-[var(--surface-1)] p-5">
        <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4">
          ...
          <div className="grid grid-cols-3 gap-3">
            {[...Array(3)].map((_, i) => (
              <div key={i} className="rounded-xl border border-black/5 dark:border-white/[0.06] bg-gray-50 dark:bg-[var(--surface-1)] p-4 min-w-[180px] space-y-2">
                <Bone className="h-2.5 w-16" />
...
export function TradesListSkeleton() {
  return (
    ...
    >
      ...
      {/* Table */}
      <div className="rounded-xl border border-black/5 dark:border-white/[0.06] bg-white dark:bg-[var(--surface-1)] overflow-hidden">
        <div className="px-4 py-3 bg-gray-50 dark:bg-[var(--surface-1)] border-b border-black/5 dark:border-white/[0.04]">
...
export function CalendarSkeleton() {
  return (
    ...
    >
      ...
      {/* Calendar grid */}
      <div className="rounded-xl border border-black/5 dark:border-white/[0.06] bg-white dark:bg-[var(--surface-raised)] overflow-hidden">
