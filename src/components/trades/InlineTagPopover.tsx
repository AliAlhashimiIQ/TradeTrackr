      ...
      {editingTag ? (
          ...
          <div className="mb-4">
            ...
            <div className="flex gap-2">
              <input
                ...
                className="flex-1 px-2.5 py-1.5 bg-gray-50 dark:bg-[#0d0e16] border border-black/10 dark:border-white/[0.06] rounded-lg text-xs text-gray-900 dark:text-white placeholder-gray-400 dark:placeholder-gray-600 focus:outline-none focus:ring-1 focus:ring-indigo-500/30"
        ...
        <>
          ...
          <div className="flex flex-wrap gap-1.5 mb-3 items-center">
            ...
            {isAddingCustomTag ? (
              <input
                ...
                className="px-2.5 py-1 bg-gray-50 dark:bg-[#0d0e16] border border-black/10 dark:border-white/[0.08] rounded-full text-xs text-gray-900 dark:text-white focus:outline-none focus:border-indigo-500/50 w-24 placeholder-gray-400 dark:placeholder-gray-700 font-sans"
                autoFocus
              />
            ) : (
              <button
          ...
          <input
            ...
            className="w-full px-2.5 py-1.5 mb-2.5 bg-gray-50 dark:bg-[#0d0e16] border border-black/10 dark:border-white/[0.06] rounded-lg text-xs text-gray-900 dark:text-white placeholder-gray-400 dark:placeholder-gray-600 focus:outline-none focus:ring-1 focus:ring-indigo-500/30"
          />
